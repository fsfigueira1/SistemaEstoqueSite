...
-- CreateEnum
CREATE TYPE "Role" AS ENUM ('ADMIN', 'MANAGER', 'USER', 'OWNER', 'EMPLOYEE');
...
-- CreateEnum
CREATE TYPE "StockMovementType" AS ENUM ('PURCHASE', 'SALE', 'SALE_RETURN', 'PURCHASE_RETURN', 'LOSS', 'THEFT', 'ADJUSTMENT_IN', 'ADJUSTMENT_OUT', 'CORRECTION');

-- CreateEnum
CREATE TYPE "PurchaseOrderStatus" AS ENUM ('PENDING', 'COMPLETED', 'CANCELLED', 'REFUNDED');

-- CreateEnum
CREATE TYPE "CashSessionStatus" AS ENUM ('OPEN', 'CLOSED');

-- CreateEnum
CREATE TYPE "CashMovementType" AS ENUM ('SALE', 'OPENING', 'WITHDRAWAL', 'DEPOSIT', 'ADJUSTMENT');
...
CREATE TABLE "Settings" (
    ...
    "companyName" TEXT NOT NULL DEFAULT 'LAÇOLARIA',
    "companyTagline" TEXT NOT NULL DEFAULT 'Papelaria e Presentes',
    "companyDoc" TEXT NOT NULL DEFAULT '',
    "companyAddress" TEXT NOT NULL DEFAULT '',
    "companyPhone" TEXT NOT NULL DEFAULT '',
    "receiptFooter" TEXT NOT NULL DEFAULT 'Obrigado pela preferencia! Troca em ate 7 dias com este comprovante.',
    "receiptShowCompany" BOOLEAN NOT NULL DEFAULT true,
    "receiptWidth" TEXT NOT NULL DEFAULT '80mm',
    "cardInterestPercent" DOUBLE PRECISION NOT NULL DEFAULT 3.5,
    "cardInterestFromInstallments" INTEGER NOT NULL DEFAULT 2,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
-- AddForeignKey
ALTER TABLE "SalePayment" ADD CONSTRAINT "SalePayment_processedById_fkey" FOREIGN KEY ("processedById") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
